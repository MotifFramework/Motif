			...
			$.post(options.ajaxUrl, {parameters: parameters},
				function(data) {
					if(options.usesPagination) {
						...
						if((parseInt(options.currentPage) + 1) != options.totalPages) {
							$('#' + options.prefix + 'Increment').attr('src', '/resources/images/admin/paginate_right.jpg');
						} else {
							$('#' + options.prefix + 'Increment').attr('src', '/resources/images/admin/paginate_right_dim.jpg');
						}
						if(options.currentPage != '0') {
							$('#' + options.prefix + 'Decrement').attr('src', '/resources/images/admin/paginate_left.jpg');
						} else {
							$('#' + options.prefix + 'Decrement').attr('src', '/resources/images/admin/paginate_left_dim.jpg');
						}
