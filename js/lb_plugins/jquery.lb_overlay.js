...
//		}
		...
		$("#lbOverlay").html("<div class='alertwindow-loader'>&nbsp;</div><div class='note'>" + options.message + "</div>");
						...
						$("<a></a>").lb_box(
							{
								...
								showClose : false,
								title : options.title,
								message : "<div class='alertwindow-loader'>&nbsp;</div><div class='note'>" + options.message + "<a class='closeOverlayBox'></a></div>",
