<?php
	...
	$mcFileManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT'] . '/media'; // absolute or relative from this script path, optional.
	$mcFileManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'] . '/media'; // absolute or relative from this script path, required.
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,doc,txt";
