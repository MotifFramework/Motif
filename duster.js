...
var input_path = "../output/dust"; // directory of dust templates are stored with .dust file extension
var output_path = "./js/dust/"; // directory where the compiled .js files should be saved to
